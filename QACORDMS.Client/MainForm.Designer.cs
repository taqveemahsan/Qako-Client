namespace QACORDMS.Client
{
    partial class MainForm
    {
        private void InitializeComponent()
        {
            ...
            backButton.Location = new Point(1401, 42);
...
//            // 
//            addUserMenuItem.Name = "addUserMenuItem";
//            addUserMenuItem.Size = new Size(98, 29);
//            addUserMenuItem.Text = "Add User";
...
//            clientsViewBox.UseCompatibleStateImageBehavior = false;
//            clientsViewBox.View = View.Details;
//            clientsViewBox.Columns.Add("Name", 260);
//            clientsViewBox.SelectedIndexChanged += ClientsViewBox_SelectedIndexChanged;
//            clientsViewBox.DoubleClick += ClientsViewBox_DoubleClick;
...
//            projectComboBox.FlatStyle = FlatStyle.Flat;
//            projectComboBox.Font = new Font("Segoe UI", 12F);
//            projectComboBox.Location = new Point(305, 80);
//            projectComboBox.Name = "projectComboBox";
//            projectComboBox.Size = new Size(1047, 36);
//            projectComboBox.TabIndex = 1;
//            projectComboBox.Items.Add("Audit");
...
//            listView1.BorderStyle = BorderStyle.None;
//            listView1.ContextMenuStrip = NewFolder;
//            listView1.Font = new Font("Segoe UI", 9F); // Smaller font for File Explorer look
//            listView1.FullRowSelect = true;
//            listView1.GridLines = true; // Add grid lines for File Explorer look
...
//            listView1.UseCompatibleStateImageBehavior = false;
//            listView1.View = View.Details;
//            listView1.Columns.Add("Name", 300); // Adjusted width
...
//            // 
//            imageList1.ColorDepth = ColorDepth.Depth32Bit;
//            imageList1.ImageSize = new Size(16, 16); // Smaller icons for File Explorer look
//            imageList1.TransparentColor = Color.Transparent;
