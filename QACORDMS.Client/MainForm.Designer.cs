namespace QACORDMS.Client
{
    partial class MainForm
    {
        private void InitializeComponent()
        {
            ...
            settingsMenuItem = new ToolStripMenuItem(); // Add Settings menu item
            ...
            menuStrip.Items.AddRange(new ToolStripItem[] { refreshMenuItem, uploadFileMenuItem, settingsMenuItem }); // Add settingsMenuItem
            ...
            settingsMenuItem.Size = new Size(100, 29);
            settingsMenuItem.Text = "Settings";
            settingsMenuItem.Click += SettingsMenuItem_Click; // Event handler for Settings
                                                              // 
                                                              // projectLabel
                                                              // 
