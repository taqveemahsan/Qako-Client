        ...
        private async Task RenameClient_Click(object sender, EventArgs e)
        {
            ...
            await RunWithLoader(async () =>
            {
                try
                {
                    ...
                    //await _apiHelper.UpdateClientAsync(client.Id, newName);
...
//            // Initialize animation timer for custom loader
//            _animationTimer = new System.Windows.Forms.Timer();
//            _animationTimer.Interval = 50; // Update every 50ms
//            _animationTimer.Tick += (s, e) =>
//            {
//                _rotationAngle = (_rotationAngle + 10) % 360; // Increment angle for rotation
//                loaderPictureBox.Invalidate(); // Redraw the PictureBox
//            };
...
//                var newMainForm = new MainForm(_apiHelper, SessionHelper.CurrentUser.Role);
//                newMainForm.Show();
//                this.Close(); // Close the current form after showing the new one
//            }
//            else
//            {
//                this.Close();
...
//            // Example: Search in listView1 or clientsViewBox
//            UpdateStatusLabel($"Searching for: {searchQuery}...");
//            // Placeholder: Add actual search implementation
//            //MessageBox.Show($"Search for '{searchQuery}' is not implemented yet.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
//        }
//        protected override void OnResize(EventArgs e)
//        {
//            base.OnResize(e);
